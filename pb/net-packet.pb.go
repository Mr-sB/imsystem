...
func (x *NetRequest) GetPid() int32 {
	if x != nil {
		return x.Pid
	}
	return 0
...
func (x *NetResponse) GetPid() int32 {
	if x != nil {
		return x.Pid
	}
	return 0
...
var file_net_packet_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x70, 0x69, 0x64, 0x12, 0x23, 0x0a, 0x07, 0x6f, 0x70, 0x5f,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x70, 0x69, 0x64, 0x12, 0x23, 0x0a, 0x07, 0x6f,
